...
public class MakeAppointmentTest extends BaseTest{
    ...
    public void MakeAppointment(String Facility, Integer BtnRadioValue,String Date, String Comment){
         ...
         //Assert.assertTrue(confirmationAppointmentPage.getHealthOptionsSelected().contains(Date));
        //System.out.println("Radio button selected is "+confirmationAppointmentPage.);
